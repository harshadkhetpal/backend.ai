...
class TestBasicFSMStates:
    ...
    def test_no_routes_creates_new(self) -> None:
        ...
        assert result.sub_step == DeployingSubStep.PROVISIONING
    ...
    def test_completed_when_all_new_healthy_and_no_old(self) -> None:
        ...
        assert result.sub_step == DeployingSubStep.COMPLETED
...
class TestRealisticScenario:
    ...
    def test_step_by_step_rolling_update(self) -> None:
        ...
        assert r4.sub_step == DeployingSubStep.PROVISIONING
        ...
        assert r5.sub_step == DeployingSubStep.COMPLETED
